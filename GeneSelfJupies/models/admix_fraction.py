...
from GeneSelfJupies.models import admix_data_processing, admix_models
...
def admix_fraction(model, genome_data, tolerance=1e-3):
    ...
    snp, minor_alleles, major_alleles, frequency = admix_data_processing.read_model(model) #读取admix model
